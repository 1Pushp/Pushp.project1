...
const ROLE_INSTRUCTIONS = {
  ...
  patient: `
    ...
    **NEW FEATURE: DRUG SAFETY MULTIPOWERED ANALYTICS**
    ...
    - **Side Effect Probability Bar Chart**: 
      - Create a specific "Comparative Analysis" section.
      - Display a visual Bar Chart comparing "Common Side Effects" (e.g., Nausea, Drowsiness) vs "Rare Side Effects" (e.g., Allergic Reaction).
      - Use CSS width percentages to show probability (e.g., Common: 40% width bar, Rare: 5% width bar).
      - Color code: Orange for Common, Red for Rare/Severe.

    - **Drug Interaction Checker**: 
      - Display a "Critical Warnings" section.
      - List specific interactions found via search (e.g., "Alcohol", "Antibiotics", "Grapefruit").
      - Use Warning Icons (⚠️) and RED/YELLOW alert boxes for high-risk interactions.
